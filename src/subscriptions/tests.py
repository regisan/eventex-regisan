...
class SubscriptionFormTest(TestCase):
    ...
    def test_email_and_phone_blank(self):
        response = self.client.post('/inscricao/', {'name': 'teste', 'cpf': '11144477735'})
        self.assertFormError(response, 'form', None, _(u'Você precisa informar seu e-mail ou seu telefone.'))
    
    def test_add_complete_form(self):
        response = self.client.post('/inscricao/', {'name': 'teste', 'cpf': '11144477735', 'email': 'teste@mail.com', 'phone_0': '11', 'phone_1': '55552222'})
        self.assertRedirects(response, '/inscricao/1/sucesso/')
        
    def test_add_no_email_form(self):
        response = self.client.post('/inscricao/', {'name': 'teste', 'cpf': '11144477735', 'phone_0': '11', 'phone_1': '55552222'})
        self.assertRedirects(response, '/inscricao/1/sucesso/')
        
    def test_add_no_phone_form(self):
        response = self.client.post('/inscricao/', {'name': 'teste', 'cpf': '11144477735', 'email': 'teste@mail.com'})
        self.assertRedirects(response, '/inscricao/1/sucesso/')
    ...
    def test_duplicated_cpf(self):
        response1 = self.client.post('/inscricao/', {'name': 'teste1', 'cpf': '11144477735', 'email': 'teste1@mail.com'})
        self.assertRedirects(response1, '/inscricao/1/sucesso/')
        response2 = self.client.post('/inscricao/', {'name': 'teste2', 'cpf': '11144477735', 'email': 'teste2@mail.com'})
        self.assertFormError(response2, 'form', 'cpf', _(u'CPF já inscrito.'))
        
    def test_duplicated_email(self):
        response1 = self.client.post('/inscricao/', {'name': 'teste1', 'cpf': '11144477735', 'email': 'teste@mail.com'})
        self.assertRedirects(response1, '/inscricao/1/sucesso/')
        response2 = self.client.post('/inscricao/', {'name': 'teste2', 'cpf': '22255588846', 'email': 'teste@mail.com'})
        self.assertFormError(response2, 'form', 'email', _(u'E-mail já inscrito.'))
        
    def test_blank_email_but_not_phone(self):
        response1 = self.client.post('/inscricao/', {'name': 'teste1', 'cpf': '11144477735', 'phone_0': '11', 'phone_1': '55552222'})
        self.assertRedirects(response1, '/inscricao/1/sucesso/')
        response2 = self.client.post('/inscricao/', {'name': 'teste2', 'cpf': '22255588846', 'phone_0': '11', 'phone_1': '55552222'})
        self.assertRedirects(response2, '/inscricao/2/sucesso/')
        
    def test_blank_phone_but_not_email(self):
        response1 = self.client.post('/inscricao/', {'name': 'teste1', 'cpf': '11144477735', 'email': 'teste@teste.com.br'})
        self.assertRedirects(response1, '/inscricao/1/sucesso/')
        response2 = self.client.post('/inscricao/', {'name': 'teste2', 'cpf': '22255588846', 'email': 'teste2@teste.com.br'})
        self.assertRedirects(response2, '/inscricao/2/sucesso/')
    ...
    def test_invalid_cpf_digit(self):
        response = self.client.post('/inscricao/', {'name': 'teste', 'cpf': '11144477730', 'email': 'teste@mail.com'})
        self.assertFormError(response, 'form', 'cpf', u'CPF inválido.')
